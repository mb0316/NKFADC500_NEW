...
///////////////////////////////////////////////////////////////////////////////
Int_t usb3tcbroot::USB3TCBWrite(UShort_t vendor_id, UShort_t product_id, UChar_t sid , UInt_t mid , UInt_t addr, UInt_t data)
{
   return ::USB3TCBWrite(vendor_id, product_id, sid, mid, addr, data);
}

///////////////////////////////////////////////////////////////////////////////
Int_t usb3tcbroot::USB3TCBRead(UShort_t vendor_id, UShort_t product_id, UChar_t sid, UInt_t mid, UInt_t count, UInt_t addr, unsigned char *data)
{
...
///////////////////////////////////////////////////////////////////////////////
unsigned long usb3tcbroot::USB3TCBReadRegL(UShort_t vendor_id, UShort_t product_id, UChar_t sid, UInt_t mid, UInt_t addr)
{
